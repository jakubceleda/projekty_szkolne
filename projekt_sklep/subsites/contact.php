...
?>
    ...
    <header>
        ...
        <div id="sklep">
            ...
            <div class="kontakt" style='font-family: Arial, Helvetica, sans-serif; font-size: larger; font-weight: bold; width:100%; text-align:center; margin: 80px 0 0 0;'>

                    <div style="width:100%;height:2px;background-color:black;margin:5px 0 5px 0;"></div>
                    <br>
                        Mail:<br>mobbyn.contact@gmail.com
                        <br><br>
                        <div style="width:100%;height:2px;background-color:black;margin:5px 0 5px 0;"></div>
                        <br>
                        Adres zwrotów i wymian:<br>Trzemeska 12, 53-679 Wrocław
                        <br><br>
                        <div style="width:100%;height:2px;background-color:black;margin:5px 0 5px 0;"></div>
                        <br>
                        Infolinia:<br>+48 845 289 929
            </div>
